...
| | AWS 프리티어 | Hetzner Cloud |
|---|---|---|
| 스펙 | t2.micro (1vCPU, 1GB) | CX22 (2vCPU, 4GB) |
| 비용 | 1년 무료 → 이후 ~$8/월 | ~€4.5/월 고정 |
| 디스크 | EBS (IOPS 제한) | 로컬 NVMe SSD |
...
레이턴시(한국 기준 ~200ms 추가)는 마라톤 신청 서비스의 특성상 문제되지 않는다.
